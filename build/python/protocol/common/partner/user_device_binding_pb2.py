...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protocol/common/partner/user_device_binding.proto',
...
_USERDEVICEBINDING = _descriptor.Descriptor(
  ...
  full_name='protocol.common.partner.UserDeviceBinding',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='device', full_name='protocol.common.partner.UserDeviceBinding.device', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='extra', full_name='protocol.common.partner.UserDeviceBinding.extra', index=5,
...
UserDeviceBinding = _reflection.GeneratedProtocolMessageType('UserDeviceBinding', (_message.Message,), {
  ...
  '__module__' : 'protocol.common.partner.user_device_binding_pb2'
