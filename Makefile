...
protocol:
	...
	protoc --proto_path=. --python_out=./build/python --java_out=./build/java --go_out=plugins=grpc:./build/go --grpc-gateway_out=logtostderr=true:./build/go --swagger_out=logtostderr=true:./build/swagger ./protocol/gaia/proxy/*.proto
	...
	cd ./build/go/tcl.com/gaia/protocol && go mod init tcl.com/gaia/protocol
